...
function (_Error) {
  ...
  function AppError(opts) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AppError).call(this, opts.message));
  ...
  Query: {
    brewerySearchInflated: function () {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 6:
                return _context2.abrupt("return", items.map(
                /*#__PURE__*/
                function () {
      ...
      function brewerySearchInflated(_x, _x2, _x3) {
        return _brewerySearchInflated.apply(this, arguments);
      }

      return brewerySearchInflated;
    }(),
    brewerySearch: function () {
      var _brewerySearch = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3(root, args, context) {
      ...
      function brewerySearch(_x5, _x6, _x7) {
        return _brewerySearch.apply(this, arguments);
      }

      return brewerySearch;
    }(),
    breweryInfo: function () {
      var _breweryInfo = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee4(root, args, context) {
        var res;
      ...
      function breweryInfo(_x8, _x9, _x10) {
        return _breweryInfo.apply(this, arguments);
      }
